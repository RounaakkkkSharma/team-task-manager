    ...
    <body class="bg-gray-100 font-sans antialiased dark:bg-gray-900">
        <main class="flex min-h-screen items-center justify-center px-6">
            <section class="max-w-md rounded-lg border border-gray-200 bg-white p-8 text-center shadow-sm dark:border-gray-700 dark:bg-gray-800">
                <p class="text-sm font-semibold uppercase text-indigo-600">404</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-900 dark:text-gray-100">That page does not exist.</h1>
                <p class="mt-3 text-sm text-gray-600 dark:text-gray-300">Use the dashboard to continue managing projects and tasks.</p>
